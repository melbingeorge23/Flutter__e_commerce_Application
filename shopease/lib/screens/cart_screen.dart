    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          if (cartProvider.items.isNotEmpty) _buildOrderSummary(cartProvider, context),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _buildBottomNavItem(Icons.search, 'Search', 1, context),
          _buildBottomNavItem(Icons.shopping_cart, 'Cart', 2, context, isActive: true),
          _buildBottomNavItem(Icons.person_outline, 'Profile', 3, context),
        ],
      ),
    );
  }

  Widget _buildBottomNavItem(IconData icon, String label, int index, BuildContext context, {bool isActive = false}) {
    return Expanded(
